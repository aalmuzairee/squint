...
const MEDIA = 'https://aalmuzairee.github.io/papers-media/squint/videos';

const taskVideos = {
  'Reach Cube':  { sim: `${MEDIA}/sim/reach_cube.mp4`, real: `${MEDIA}/real/reach_cube.mp4` },
  'Reach Can':   { sim: `${MEDIA}/sim/reach_can.mp4`,  real: `${MEDIA}/real/reach_can.mp4` },
  'Lift Cube':   { sim: `${MEDIA}/sim/lift_cube.mp4`,  real: `${MEDIA}/real/lift_cube.mp4` },
  'Lift Can':    { sim: `${MEDIA}/sim/lift_can.mp4`,   real: `${MEDIA}/real/lift_can.mp4` },
  'Place Cube':  { sim: `${MEDIA}/sim/place_cube.mp4`, real: `${MEDIA}/real/place_cube.mp4` },
  'Place Can':   { sim: `${MEDIA}/sim/place_can.mp4`,  real: `${MEDIA}/real/place_can.mp4` },
  'Stack Cube':  { sim: `${MEDIA}/sim/stack_cube.mp4`, real: `${MEDIA}/real/stack_cube.mp4` },
  'Stack Can':   { sim: `${MEDIA}/sim/stack_can.mp4`,  real: `${MEDIA}/real/stack_can.mp4` },
};
